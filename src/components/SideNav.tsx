...
const SideNav = ({
  ...
  return (
    <nav
      className={`${
        currentTab === "Direct Messages" ? "flex" : "md:flex hidden"
      } flex-col items-center shrink-0 relative lg:p-6 p-2 bg-slate-950`}
    >
      <button
        className="p-3 bg-slate-800 hover:bg-red-400 rounded-full cursor-pointer"
        onClick={() => {
